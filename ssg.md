...
* **[key pair](#image:images/yes.png[yes]-key-pair-(noun))**: Added glossary entry
* **[remote execution](#image:images/yes.png[yes]-remote-execution-(noun,-adjective))**: Added glossary entry
* **[REX](#image:images/yes.png[yes]-rex-(noun,-adjective))**: Added glossary entry
* **[Technology Preview](#image:images/yes.png[yes]-technology-preview-(noun))**: Updated glossary entry
...
* **[Base64](#image:images/yes.png[yes]-base64-(noun,-adjective))**: Added glossary entry
* **[offline](#image:images/yes.png[yes]-offline-(adjective))**: Added glossary entry
...
* **[FedRAMP®](#image:images/yes.png[yes]-fedramp®-(noun))**: Added glossary entry
...
* **[access mode](#image:images/yes.png[yes]-access-mode-(noun))**: Added glossary entry
* **[availability](#image:images/caution.png[with-caution]-availability-(adjective))**: Added glossary entry
* **[availability zone](#image:images/yes.png[yes]-availability-zone-(noun))**: Added glossary entry
* **[Bare Metal service](#image:images/yes.png[yes]-bare-metal-service-(noun))**: Added glossary entry
* **[bind](#image:images/yes.png[yes]-bind-(verb))**: Added glossary entry
* **[block device](#image:images/caution.png[with-caution]-block-device-(noun))**: Added glossary entry
* **[block storage](#image:images/caution.png[with-caution]-block-storage-(noun))**: Added glossary entry
* **[block volume](#image:images/caution.png[with-caution]-block-volume-(noun))**: Added glossary entry
* **[boot source](#image:images/yes.png[yes]-boot-source-(noun))**: Added glossary entry
* **[brick](#image:images/yes.png[yes]-brick-(noun))**: Added glossary entry
* **[client](#image:images/yes.png[yes]-client)**: Updated glossary entry to include a generic definition
* **[clone (noun)](#image:images/yes.png[yes]-clone-(noun))**: Added glossary entry
* **[clone (verb)](#image:images/yes.png[yes]-clone-(verb))**: Added glossary entry
* **[cloud storage](#image:images/yes.png[yes]-cloud-storage-(noun))**: Added glossary entry
* **[compression](#image:images/caution.png[with-caution]-compression-(noun))**: Added glossary entry
* **[control plane node](#image:images/yes.png[yes]-control-plane-node-(noun))**: Added glossary entry
* **[controller node](#image:images/yes.png[yes]-controller-node-(noun))**: Added glossary entry
* **[copy](#image:images/yes.png[yes]-copy-(verb))**: Added glossary entry
* **[currently](#image:images/yes.png[yes]-currently-(adverb))**: Added glossary entry
* **[data compression](#image:images/caution.png[with-caution]-data-compression-(noun))**: Added glossary entry
* **[deduplication](#image:images/yes.png[yes]-deduplication-(noun))**: Added glossary entry
* **[directory](#image:images/yes.png[yes]-directory-(noun))**: Added glossary entry
* **[disaster recovery](#image:images/yes.png[yes]-disaster-recovery-(adjective))**: Added glossary entry
* **[disk encryption](#image:images/yes.png[yes]-disk-encryption-(noun))**: Added glossary entry
* **[dispersed volume](#image:images/yes.png[yes]-dispersed-volume-(noun))**: Added glossary entry
* **[distributed file system](#image:images/yes.png[yes]-distributed-file-system-(noun))**: Added glossary entry
* **[distributed volume](#image:images/yes.png[yes]-distributed-volume-(noun))**: Added glossary entry
* **[distributed-dispersed volume](#image:images/yes.png[yes]-distributed-dispersed-volume-(noun))**: Added glossary entry
* **[distributed-replicated volume](#image:images/yes.png[yes]-distributed-replicated-volume-(noun))**: Added glossary entry
* **[dynamically provisioned storage](#image:images/caution.png[with-caution]-dynamically-provisioned-storage-(noun))**: Added glossary entry
* **[egress](#image:images/yes.png[yes]-egress-(adjective))**: Added glossary entry
* **[encrypted disk](#image:images/yes.png[yes]-encrypted-disk-(noun))**: Added glossary entry
* **[encryption](#image:images/yes.png[yes]-encryption-(noun))**: Added glossary entry
* **[ephemeral storage](#image:images/yes.png[yes]-ephemeral-storage-(noun))**: Added glossary entry
* **[external mode](#image:images/caution.png[with-caution]-external-mode-(noun))**: Added glossary entry
* **[file storage](#image:images/yes.png[yes]-file-storage-(noun))**: Added glossary entry
* **[FUSE](#image:images/caution.png[with-caution]-fuse)**: Added glossary entry
* **[geo-replication](#image:images/caution.png[with-caution]-geo-replication-(noun))**: Added glossary entry
* **[gluster volume](#image:images/yes.png[yes]-gluster-volume-(noun))**: Added glossary entry
* **[high-availability cluster](#image:images/yes.png[yes]-high-availability-cluster-(noun))**: Added glossary entry
* **[hyperconverged cluster](#image:images/yes.png[yes]-hyperconverged-cluster-(noun))**: Added glossary entry
* **[infrastructure node](#image:images/yes.png[yes]-infrastructure-node-(noun))**: Added glossary entry
* **[initiator](#image:images/yes.png[yes]-initiator-(noun))**: Added glossary entry
* **[internal mode](#image:images/yes.png[yes]-internal-mode-(noun))**: Added glossary entry
* **[local storage](#image:images/yes.png[yes]-local-storage-(noun))**: Added glossary entry
* **[logical cache](#image:images/yes.png[yes]-logical-cache-(noun))**: Added glossary entry
* **[logical volume](#image:images/yes.png[yes]-logical-volume-(noun))**: Added glossary entry
* **[metadata](#image:images/yes.png[yes]-metadata-(noun))**: Added glossary entry
* **[multipath](#image:images/caution.png[with-caution]-multipath-(noun))**: Added glossary entry
* **[network encryption](#image:images/yes.png[yes]-network-encryption-(noun))**: Added glossary entry
* **[Network Time Configuration](#image:images/yes.png[yes]-network-time-configuration-(noun))**: Added glossary entry
* **[n-way replication](#image:images/yes.png[yes]-n-way-replication-(noun))**: Added glossary entry
* **[object storage](#image:images/yes.png[yes]-object-storage-(noun))**: Added glossary entry
* **[OpenShift Container Platform cluster](#image:images/yes.png[yes]-openshift-container-platform-cluster-(noun))**: Added glossary entry
* **[phase](#image:images/yes.png[yes]-phase-(noun))**: Added glossary entry
* **[physical disk](#image:images/yes.png[yes]-physical-disk-(noun))**: Added glossary entry
* **[physical volume](#image:images/yes.png[yes]-physical-volume-(noun))**: Added glossary entry
* **[platform](#image:images/caution.png[with-caution]-platform-(noun))**: Added glossary entry
* **[primary cluster](#image:images/yes.png[yes]-primary-cluster-(noun))**: Added glossary entry
* **[primary node](#image:images/yes.png[yes]-primary-node-(noun))**: Added glossary entry
* **[provision](#image:images/caution.png[with-caution]-provision-(verb))**: Added glossary entry
* **[proxy](#image:images/caution.png[with-caution]-proxy-(noun))**: Added glossary entry
* **[replicated volume](#image:images/yes.png[yes]-replicated-volume-(noun))**: Added glossary entry
* **[restore](#image:images/yes.png[yes]-restore-(verb))**: Added glossary entry
* **[rpm-ostree](#image:images/yes.png[yes]-rpm-ostree-(noun))**: Updated glossary entry to add formatting guidance
* **[scale out](#image:images/yes.png[yes]-scale-out-(verb))**: Added glossary entry
* **[scale up](#image:images/yes.png[yes]-scale-up-(verb))**: Added glossary entry
* **[secondary cluster](#image:images/yes.png[yes]-secondary-cluster-(noun))**: Added glossary entry
* **[self-healing](#image:images/yes.png[yes]-self-healing-(noun))**: Added glossary entry
* **[server](#image:images/yes.png[yes]-server-(noun))**: Added glossary entry
* **[snapshot](#image:images/yes.png[yes]-snapshot-(noun))**: Added glossary entry
* **[source node](#image:images/yes.png[yes]-source-node-(noun))**: Added glossary entry
* **[source volume](#image:images/yes.png[yes]-source-volume-(noun))**: Added glossary entry
* **[split brain](#image:images/yes.png[yes]-split-brain-(noun))**: Added glossary entry
* **[storage cluster](#image:images/yes.png[yes]-storage-cluster-(noun))**: Added glossary entry
* **[storage pool](#image:images/yes.png[yes]-storage-pool-(noun))**: Added glossary entry
* **[stripe](#image:images/yes.png[yes]-stripe-(noun))**: Added glossary entry
* **[subvolume](#image:images/caution.png[with-caution]-subvolume-(noun))**: Added glossary entry
* **[target](#image:images/yes.png[yes]-target-(noun))**: Updated glossary entry to include a generic definition
* **[target volume](#image:images/yes.png[yes]-target-volume-(noun))**: Added glossary entry
* **[thickly provisioned](#image:images/yes.png[yes]-thickly-provisioned-(adjective))**: Added glossary entry
* **[total capacity](#image:images/yes.png[yes]-total-capacity-(noun))**: Added glossary entry
* **[translator](#image:images/yes.png[yes]-translator-(noun))**: Added glossary entry
* **[usable capacity](#image:images/yes.png[yes]-usable-capacity-(noun))**: Added glossary entry
* **[virtual disk](#image:images/yes.png[yes]-virtual-disk-(noun))**: Added glossary entry
* **[volume file](#image:images/yes.png[yes]-volume-file-(noun))**: Added glossary entry
* **[volume group](#image:images/yes.png[yes]-volume-group-(noun))**: Added glossary entry
* **[worker node](#image:images/yes.png[yes]-worker-node-(noun))**: Added glossary entry
...
* **[Customer Portal](#image:images/caution.png[with-caution]-customer-portal-(noun))**: Added glossary entry
* **[hashbang](#image:images/no.png[no]-hashbang-(noun))**: Added glossary entry
* **[ingress](#image:images/yes.png[yes]-ingress-(noun,-adjective))**: Updated guidance from uppercase "Ingress" to lowercase "ingress"
* **[interpreter directive](#image:images/yes.png[yes]-interpreter-directive-(noun))**: Added glossary entry
* **[shebang](#image:images/yes.png[yes]-shebang-(noun))**: Added glossary entry
...
* **[IBM Cloud®](#image:images/yes.png[yes]-ibm-cloud®-(noun))**: Added glossary entry
...
* **[now](#image:images/caution.png[caution]-now-(adverb))**: Updated glossary entry to "use with caution"
* **[previously](#image:images/caution.png[caution]-previously-(adverb))**: Added glossary entry
...
* **[Ansible Rulebook](#image:images/yes.png[yes]-ansible-rulebook-(noun))**: Added glossary entry
* **because**: Removed glossary entry because guidance already exists in the _IBM Style_ guidance
* **[executable (adjective)](#image:images/yes.png[yes]-executable-(adjective))**: Added glossary entry
* **[executable (noun)](#image:images/caution.png[with-caution]-executable-(noun))**: Added glossary entry
* **[playbook](#image:images/yes.png[yes]-playbook-(noun))**: Added glossary entry
* **[rulebook](#image:images/yes.png[yes]-rulebook-(noun))**: Added glossary entry
* **[spec file](#image:images/yes.png[yes]-spec-file-(noun))**: Updated glossary entry for clarity

### September 2023

**Glossary entries**

* **[AWS Local Zone](#image:images/yes.png[yes]-aws-local-zone-(noun))**: Added glossary entry
* **[AWS opt-in Region](#image:images/yes.png[yes]-aws-opt-in-region-(noun))**: Added glossary entry
* **[IBM Cloud® Bare Metal (Classic)](#image:images/yes.png[yes]-ibm-cloud®-bare-metal-(classic)-(noun))**: Added glossary entry
* **[IBM eServer System i](#image:images/no.png[no]-ibm-eserver-system-i-(noun))**: Added glossary entry with "do not use" guidance
* **[inject](#image:images/yes.png[yes]-inject-(verb))**: Added glossary entry
* **[opt in](#image:images/yes.png[yes]-opt-in-(verb))**: Added glossary entry
* **pulldown**: Removed glossary entry in favor of following the _IBM Style_ guidance on using "dropdown" and "drop-down"
* **[segmentation fault](#image:images/yes.png[yes]-segmentation-fault-(noun))**: Updated glossary entry for clarity
...
* **[Application Stream](#image:images/yes.png[yes]-application-stream-(noun))**: Added glossary entry
* **[Appstream repository](#image:images/yes.png[yes]-appstream-repository-(noun))**: Added glossary entry
* **[BaseOS repository](#image:images/yes.png[yes]-baseos-repository-(noun))**: Added glossary entry
* **[binary RPM](#image:images/yes.png[yes]-binary-rpm-file-(noun))**: Added glossary entry
* **[Boolean dependencies](#image:images/yes.png[yes]-boolean-dependencies-(noun))**: Added glossary entry
* **[byte-compiled program](#image:images/yes.png[yes]-byte-compiled-program-(noun))**: Added glossary entry
...
* **[CodeReady Linux Builder repository](#image:images/caution.png[with-caution]-codeready-linux-builder-repository-(noun))**: Added glossary entry
...
* **[DNF Automatic](#image:images/yes.png[yes]-dnf-automatic-(noun))**: Added glossary entry
* **[domain controller](#image:images/yes.png[yes]-domain-controller-(noun))**: Updated glossary entry to include IdM-specific information
* **[file trigger directive](#image:images/yes.png[yes]-file-trigger-directive-(noun))**: Added glossary entry
* **[IBM eServer System p](#image:images/no.png[no]-ibm-eserver-system-p-(noun))**: Updated to "do not use"; use "IBM Power" instead
* **[IBM S/390](#image:images/no.png[no]-ibm-s/390-(noun))**: Updated to "do not use"; use "IBM Z" instead
* **[interpreted code](#image:images/yes.png[yes]-interpreted-code-(noun))**: Added glossary entry
* **[ISeries](#image:images/no.png[no]-iseries-(noun))**: Updated to "do not use"; use "IBM Power" instead
* **[module](#image:images/yes.png[yes]-module-(noun))**: Added glossary entry
* **[module profile](#image:images/yes.png[yes]-module-profile-(noun))**: Added glossary entry
* **[module stream](#image:images/yes.png[yes]-module-stream-(noun))**: Added glossary entry
* **[natively compiled code](#image:images/yes.png[yes]-natively-compiled-code-(noun))**: Added glossary entry
* **[pSeries](#image:images/no.png[no]-pseries-(noun))**: Updated to "do not use"; use "IBM Power" instead
* **[raw-interpreted program](#image:images/yes.png[yes]-raw-interpreted-program-(noun))**: Added glossary entry
* **[Rolling Stream](#image:images/yes.png[yes]-rolling-stream-(noun))**: Added glossary entry
* **[RPM macro](#image:images/yes.png[yes]-rpm-macro-(noun))**: Added glossary entry
* **[scriptlet directive](#image:images/yes.png[yes]-scriptlet-directive-(noun))**: Added glossary entry
* **[Source RPM](#image:images/yes.png[yes]-source-rpm-(noun))**: Added glossary entry
* **[trigger directive](#image:images/yes.png[yes]-trigger-directive-(noun))**: Added glossary entry
* **[Weak dependencies](#image:images/yes.png[yes]-weak-dependencies-(noun))**: Added glossary entry
...
* **[Elastic Load Balancing](#image:images/yes.png[yes]-elastic-load-balancing-(noun))**: Added glossary entry
...
* **[Ansible Playbook](#image:images/yes.png[yes]-ansible-playbook-(noun))**: Updated glossary entry for preferred spelling
* **[bimodal IT](#image:images/caution.png[with-caution]-bimodal-it-(noun))**: Updated glossary entry to include link to the Gartner website
* **[bimonthly](#image:images/no.png[no]-bimonthly-(adverb))**: Updated to "do not use" because the term can be ambiguous
* **[biweekly](#image:images/no.png[no]-biweekly-(adverb))**: Updated to "do not use" because the term can be ambiguous
* **[codebase](#image:images/yes.png[yes]-codebase-(noun))**: Added glossary entry
* **[sos report](#image:images/caution.png[with-caution]-sos-report-(noun))**: Added glossary entry
* **[sosreport](#image:images/caution.png[with-caution]-sosreport-(noun))**: Added glossary entry
...
* **[64-bit ARM](#image:images/yes.png[yes]-64-bit-arm-(noun))**: Added glossary entry
* **[64-bit x86](#image:images/yes.png[yes]-64-bit-x86-(noun))**: Added glossary entry
* **[AArch64](#image:images/yes.png[yes]-aarch64-(noun))**: Added glossary entry
* **[aarch64](#image:images/yes.png[yes]-aarch64-(noun))**: Added glossary entry
* **[AMD64](#image:images/yes.png[yes]-amd64-(noun))**: Updated description
* **[amd64](#image:images/yes.png[yes]-amd64-(noun))**: Added glossary entry
* **[ARM64](#image:images/yes.png[yes]-arm64-(noun))**: Added glossary entry
* **[arm64](#image:images/yes.png[yes]-arm64-(noun))**: Added glossary entry
* **[Intel 64](#image:images/yes.png[yes]-intel-64-(noun))**: Added glossary entry
* **[softirq](#image:images/yes.png[yes]-softirq-(noun))**: Added glossary entry
* **[x86_64](#image:images/yes.png[yes]-x86_64-(noun))**: Added glossary entry
...
* **[Apache web server](#image:images/yes.png[yes]-apache-web-server-(noun))**: Updated to remove extraneous IdM definitions
* **[certificate authority](#image:images/yes.png[yes]-certificate-authority-(noun))**: Renamed from "certificate authorities", and updated to remove extraneous IdM definitions
* **[domain controller](#image:images/yes.png[yes]-domain-controller-(noun))**: Updated to remove extraneous IdM definitions
* **[Kerberos protocol](#image:images/yes.png[yes]-kerberos-protocol-(noun))**: Updated to remove extraneous IdM definitions
* **[Kerberos realm](#image:images/yes.png[yes]-kerberos-realm-(noun))**: Updated to remove extraneous IdM definitions
* **[POSIX attributes](#image:images/yes.png[yes]-posix-attributes-(noun))**: Updated to remove extraneous IdM definitions
* **[web server](#image:images/yes.png[yes]-web-server-(noun))**: Updated to remove extraneous IdM definitions
...
* **[devfile](#image:images/yes.png[yes]-devfile-(noun))**: Added glossary entry
...
* **[Foreman](#image:images/caution.png[with-caution]-foreman-(noun))**: Updated to remove outdated guidance
* **[session persistence](#image:images/yes.png[yes]-session-persistence-(noun))**: Added glossary entry
* **[sticky bit](#image:images/yes.png[yes]-sticky-bit-(noun))**: Added glossary entry
* **[sticky session](#image:images/yes.png[yes]-sticky-session-(noun))**: Added glossary entry
* **[want](#image:images/caution.png[with-caution]-want-(verb))**: Updated to "use with caution"
* **[we suggest](#image:images/no.png[no]-we-suggest-(verb))**: Updated to remove outdated guidance
...
* **[Assisted Installer](#image:images/yes.png[yes]-assisted-installer-(noun))**: Added glossary entry
* **[Basic HTTP authentication](#image:images/yes.png[yes]-basic-http-authentication-(noun))**: Added glossary entry
* **[bytecode](#image:images/yes.png[yes]-bytecode-(noun))**: Added glossary entry
* **[Developer Preview](#image:images/yes.png[yes]-developer-preview-(noun))**: Added glossary entry
* **[Kubernetes](#image:images/yes.png[yes]-kubernetes-(noun))**: Added glossary entry
...
* Do not use "now" to refer to the state after the update. For more information, see the [now](#image:images/caution.png[caution]-now-(adverb)) glossary entry.
...
* Write the proposed alternative for the user. Do not use the term “Recommended”. See the [recommend](#image:images/no.png[no]-recommend-(verb)) glossary entry.
...
* Use “before this update” instead of “previously” to refer to the past situation. See the [previously](#image:images/caution.png[caution]-previously-(adverb)) glossary entry.
...
**See also**: [aarch64](#image:images/yes.png[yes]-aarch64-(noun))
...
**See also**: [ACK flag](#image:images/yes.png[yes]-ack-flag-(noun))
...
**See also**: [project](#image:images/yes.png[yes]-project-(noun)), [verb](#image:images/yes.png[yes]-verb-(noun))
...
**See also**: [Active directory forest](#image:images/yes.png[yes]-active-directory-forest-(noun))
...
**See also**: [JBoss EAP messaging](#image:images/yes.png[yes]-jboss-eap-messaging-(noun))
...
**See also**: [Ansible Playbook](#image:images/yes.png[yes]-ansible-playbook-(noun))
...
**See also**: [Ansible play](#image:images/yes.png[yes]-ansible-play-(noun)), [playbook](#image:images/yes.png[yes]-playbook-(noun))
...
**See also**: [rulebook](#image:images/yes.png[yes]-rulebook-(noun))
...
**See also**: [endpoint](#image:images/caution.png[with-caution]-endpoint-(noun))
...
**See also**: [AppStream repository](#image:images/yes.png[yes]-appstream-repository-(noun))
...
**See also**: [Application Stream](#image:images/yes.png[yes]-application-stream-(noun))
...
**See also**: [AMQ Broker](#image:images/yes.png[yes]-amq-broker-(noun))
...
**See also**: [action](#image:images/yes.png[yes]-action-(noun)), [identity](#image:images/yes.png[yes]-identity-(noun))
...
**See also**: [high-availability](#image:images/yes.png[yes]-high-availability-(adjective)), [availability zone](#image:images/yes.png[yes]-availability-zone-(noun))
...
**See also**: [high-availability](#image:images/yes.png[yes]-high-availability-(adjective))
...
**See also**:  [Microsoft Azure Cross-Platform Command-Line Interface](#image:images/yes.png[yes]-microsoft-azure-cross-platform-command-line-interface-(noun))
...
**See also**: [arm64](#image:images/yes.png[yes]-arm64-(noun))
...
**See also**: [opt in](#image:images/yes.png[yes]-opt-in-(verb)), [AWS opt-in Region](#image:images/yes.png[yes]-aws-opt-in-region-(noun))
...
**See also**: [Azure Service Management](#image:images/yes.png[yes]-azure-service-management-(noun))
...
**See also**: [Azure Resource Manager](#image:images/yes.png[yes]-azure-resource-manager-(noun))
...
**See also**: [latency](#image:images/yes.png[yes]-latency-(noun))
...
**See also**: [bare-metal (adjective)](#image:images/yes.png[yes]-bare-metal-(adjective))
...
**See also**: [distinguished name](#image:images/yes.png[yes]-distinguished-name-(noun))
...
**See also**: [RPM](#image:images/yes.png[yes]-rpm-(noun))
...
**See also**: [BIND (noun)](#image:images/yes.png[yes]-bind-(noun))
...
**See also**: [distinguished name](#image:images/yes.png[yes]-distinguished-name-(noun)), [bind (verb)](#image:images/yes.png[yes]-bind-(verb))
...
**See also**: [firmware](#image:images/yes.png[yes]-firmware-(noun))
...
**See also**: [block storage](#image:images/caution.png[with-caution]-block-storage-(noun)), [block volume](#image:images/caution.png[with-caution]-block-volume-(noun))
...
**See also**: [block device](#image:images/caution.png[with-caution]-block-device-(noun)), [block volume](#image:images/caution.png[with-caution]-block-volume-(noun))
...
**See also**: [Weak dependencies](#image:images/yes.png[yes]-weak-dependencies-(noun))
...
**See also**: [broadcast (verb)](#image:images/yes.png[yes]-broadcast-(verb))
...
**See also**: [broadcast (noun)](#image:images/yes.png[yes]-broadcast-(noun))
...
**See also**: [AMQ Broker](#image:images/yes.png[yes]-amq-broker-(noun)), [broker distribution](#image:images/yes.png[yes]-broker-distribution-(noun))
...
**See also**: [shard](#image:images/yes.png[yes]-shard-(noun))
...
**See also**: [build](#image:images/yes.png[yes]-build-(noun))
...
**See also**: [CD](#image:images/yes.png[yes]-cd-(noun))
...
**See also**: [Metadata Server](#image:images/yes.png[yes]-metadata-server-(noun)), [MDS](#image:images/yes.png[yes]-mds-(noun))
...
**See also**: [Ceph Monitor](#image:images/yes.png[yes]-ceph-monitor-(noun))
...
**See also**: [Ceph File System](#image:images/yes.png[yes]-ceph-file-system-(noun))
...
**See also**: [certificate](#image:images/yes.png[yes]-certificate-(noun))
...
**See also**: [upgrade](#image:images/yes.png[yes]-upgrade-(verb)), [in-place upgrade](#image:images/yes.png[yes]-in-place-upgrade-(noun))
...
**See also**: [clone (verb)](#image:images/yes.png[yes]-clone-(verb))
...
**See also**: [clone (noun)](#image:images/yes.png[yes]-clone-(noun))
...
**See also**: [CSV](#image:images/yes.png[yes]-csv-(noun))
...
**See also**: [content view](#image:images/yes.png[yes]-content-view-(noun))
...
**See also**: [bucket](#image:images/yes.png[yes]-bucket-(noun)), [connection](#image:images/yes.png[yes]-connection-(noun))
...
**See also**: [containerized](#image:images/yes.png[yes]-containerized-(adjective))
...
**See also**: [composite content view](#image:images/yes.png[yes]-composite-content-view-(noun))
...
**See also**: [API server](#image:images/yes.png[yes]-api-server-(noun)), [scheduler](#image:images/yes.png[yes]-scheduler-(noun))
...
**See also**: [raw](#image:images/yes.png[yes]-raw-(adjective))
...
**See also**: [Core protocol](#image:images/yes.png[yes]-core-protocol-(noun)), [AMQ Core Protocol JMS](#image:images/yes.png[yes]-amq-core-protocol-jms-(noun))
...
**See also**: [CRUSH](#image:images/yes.png[yes]-crush-(noun))
...
**See also**: [comma-separated values](#image:images/yes.png[yes]-comma-separated-values-(noun))
...
**See also**: [daisy chain (verb)](#image:images/yes.png[yes]-daisy-chain-(verb))
...
**See also**: [daisy chain (noun)](#image:images/yes.png[yes]-daisy-chain-(noun))
...
**See also**: [debug (verb)](#image:images/yes.png[yes]-debug-(verb))
...
**See also**: [debug (adjective)](#image:images/yes.png[yes]-debug-(adjective))
...
**See also**: [message settlement](#image:images/yes.png[yes]-message-settlement-(noun))
...
**See also**: [denial of service (adjective)](#image:images/yes.png[yes]-denial-of-service-(adjective))
...
**See also**: [desktop (noun)](#image:images/yes.png[yes]-desktop-(noun))
...
**See also**: [desktop (adjective)](#image:images/yes.png[yes]-desktop-(adjective))
...
**See also**: [AMQ Interconnect](#image:images/yes.png[yes]-amq-interconnect-(noun))
...
**See also**: [brick](#image:images/yes.png[yes]-brick-(noun))
...
**See also**: [managed domain](#image:images/yes.png[yes]-managed-domain-(noun))
...
**See also**: [download (verb)](#image:images/yes.png[yes]-download-(verb))
...
**See also**: [Security - Elytron](#image:images/yes.png[yes]-security---elytron-(noun))
...
**See also**: [component](#image:images/yes.png[yes]-component-(noun)), [consumer](#image:images/yes.png[yes]-consumer-(noun)), [producer](#image:images/yes.png[yes]-producer-(noun))
...
**See also**: [subscription](#image:images/yes.png[yes]-subscription-(noun)), [repository](#image:images/yes.png[yes]-repository-(noun))
...
**See also**: [XP](#image:images/yes.png[yes]-xp-(noun))
...
**See also**: [crash](#image:images/caution.png[with-caution]-crash-(verb))
...
**See also**: [fault-tolerant](#image:images/yes.png[yes]-fault-tolerant-(adjective))
...
**See also**: [BIOS](#image:images/caution.png[with-caution]-bios-(noun))
...
**See also**: [futexes](#image:images/yes.png[yes]-futexes-(noun)), [mutex](#image:images/yes.png[yes]-mutex-(noun))
...
**See also**: [futex](#image:images/yes.png[yes]-futex-(noun)), [mutexes](#image:images/yes.png[yes]-mutexes-(noun))
...
**See also**: [gas](#image:images/yes.png[yes]-gas-(noun))
...
**See also**: [gigabyte](#image:images/yes.png[yes]-gigabyte-(noun))
...
**See also**: [gcc](#image:images/yes.png[yes]-gcc-(noun))
...
**See also**: [gcj](#image:images/yes.png[yes]-gcj-(noun)), [GCC](#image:images/yes.png[yes]-gcc-(noun))
...
**See also**: [GB](#image:images/yes.png[yes]-gb-(noun))
...
**See also**: [GNOME Classic](#image:images/yes.png[yes]-gnome-classic-(noun))
...
**See also**: [GNOME](#image:images/yes.png[yes]-gnome-(noun))
...
**See also**: [Business Central](#image:images/yes.png[yes]-business-central-(noun))
...
**See also**: [interpreter directive](#image:images/yes.png[yes]-interpreter-directive-(noun)), [shebang](#image:images/yes.png[yes]-shebang-(noun))
...
**See also**: [DNS SRV records](#image:images/yes.png[yes]-dns-srv-records-(noun))
...
**See also**: [high availability](#image:images/yes.png[yes]-high-availability-(noun))
...
**See also**: [availability](#image:images/caution.png[with-caution]-availability-(adjective))
...
**See also**: [target system](#image:images/yes.png[yes]-target-system-(noun))
...
**See also**: [hot plug](#image:images/yes.png[yes]-hot-plug-(verb)), [hot swap](#image:images/yes.png[yes]-hot-swap-(verb))
...
**See also**: [hot add](#image:images/yes.png[yes]-hot-add-(verb)), [hot plug](#image:images/yes.png[yes]-hot-plug-(verb))
...
**See also**: [management console](#image:images/yes.png[yes]-management-console-(noun))
...
**See also**: [consumer](#image:images/yes.png[yes]-consumer-(noun)), [LDAP](#image:images/yes.png[yes]-ldap-(noun))
...
**See also**: [huge-page (adjective)](#image:images/yes.png[yes]-huge-page-(adjective))
...
**See also**: [huge page (noun)](#image:images/yes.png[yes]-huge-page-(noun))
...
**See also**: [hypervisor](#image:images/yes.png[yes]-hypervisor-(noun))
...
**See also**: [PaaS](#image:images/yes.png[yes]-paas-(noun)), [SaaS](#image:images/yes.png[yes]-saas-(noun))
...
**See also**: [IBM Cloud® Bare Metal (Classic)](#image:images/yes.png[yes]-ibm-cloud®-bare-metal-(classic)-(noun))
...
**See also**: [IBM Cloud®](#image:images/yes.png[yes]-ibm-cloud®-(noun))
...
**See also**: [IBM Power®](#image:images/yes.png[yes]-ibm-power®-(noun)), [iSeries](#image:images/no.png[no]-iseries-(noun))
...
**See also**: [IBM Power®](#image:images/yes.png[yes]-ibm-power®-(noun))
...
**See also**: [IBM Z®](#image:images/yes.png[yes]-ibm-z®-(noun)), [s390x](#image:images/yes.png[yes]-s390x-(noun))
...
**See also**: [IBM® LinuxONE](#image:images/yes.png[yes]-ibm®-linuxone-(noun)), [IBM Z®](#image:images/yes.png[yes]-ibm-z®-(noun)), [s390x](#image:images/yes.png[yes]-s390x-(noun))
...
**See also**: [POSIX attributes](#image:images/yes.png[yes]-posix-attributes-(noun))
...
**See also**: [identity provider](#image:images/yes.png[yes]-identity-provider-(noun)), [identity provider mappers](#image:images/yes.png[yes]-identity-provider-mappers-(noun))
...
**See also**: [identity provider](#image:images/yes.png[yes]-identity-provider-(noun)), [identity provider federation](#image:images/yes.png[yes]-identity-provider-federation-(noun)), [identity token](#image:images/yes.png[yes]-identity-token-(noun))
...
**See also**: [image](#image:images/yes.png[yes]-image-(noun))
...
**See also**: [upgrade](#image:images/yes.png[yes]-upgrade-(verb)), [clean install](#image:images/yes.png[yes]-clean-install-(noun))
...
**See also**: [GDB](#image:images/yes.png[yes]-gdb-(noun)), [gdb](#image:images/yes.png[yes]-gdb-(noun))
...
**See also**: [raw-interpreted program](#image:images/yes.png[yes]-raw-interpreted-program-(noun)), [byte-compiled program](#image:images/yes.png[yes]-byte-compiled-program-(noun))
...
**See also**: [IPv4](#image:images/yes.png[yes]-ipv4-(noun)), [IPv6](#image:images/yes.png[yes]-ipv6-(noun))
...
**See also**: [IP](#image:images/yes.png[yes]-ip-(noun))
...
**See also**: [IBM Power®](#image:images/yes.png[yes]-ibm-power®-(noun)), [IBM eServer System i](#image:images/no.png[no]-ibm-eserver-system-i-(noun))
...
**See also**: [Itanium 2](#image:images/yes.png[yes]-itanium-2-(noun))
...
**See also**: [Itanium](#image:images/yes.png[yes]-itanium-(noun))
...
**See also**: [JavaScript](#image:images/yes.png[yes]-javascript-(noun))
...
**See also**: [built-in messaging](#image:images/yes.png[yes]-built-in-messaging-(noun)), [JBoss EAP built-in messaging](#image:images/yes.png[yes]-jboss-eap-built-in-messaging-(noun))
...
**See also**: [kB](#image:images/yes.png[yes]-kb-(noun))
...
**See also**: [kerberized](#image:images/no.png[no]-kerberized-(adjective))
...
**See also**: [kerberize](#image:images/no.png[no]-kerberize-(verb))
...
**See also**: [Kerberos principal](#image:images/yes.png[yes]-kerberos-principal-(noun))
...
**See also**: [Kerberos realm](#image:images/yes.png[yes]-kerberos-realm-(noun))
...
**See also**: [IdM deployment](#image:images/yes.png[yes]-idm-deployment-(noun)), [Key Distribution Center](#image:images/yes.png[yes]-key-distribution-center-(noun))
...
**See also**: [Key Distribution Center](#image:images/yes.png[yes]-key-distribution-center-(noun))
...
**See also**: [kernel panic](#image:images/yes.png[yes]-kernel-panic-(noun)), [kernel space](#image:images/yes.png[yes]-kernel-space-(noun)), [kernel-space](#image:images/yes.png[yes]-kernel-space-(adjective))
...
**See also**: [kernel](#image:images/yes.png[yes]-kernel-(noun)), [kernel panic](#image:images/yes.png[yes]-kernel-panic-(noun))
...
**See also**: [kernel](#image:images/yes.png[yes]-kernel-(noun)), [kernel oops](#image:images/yes.png[yes]-kernel-oops-(noun))
...
**See also**: [kernel](#image:images/yes.png[yes]-kernel-(noun)), [kernel-space](#image:images/yes.png[yes]-kernel-space-(adjective))
...
**See also**: [kernel](#image:images/yes.png[yes]-kernel-(noun)), [kernel space](#image:images/yes.png[yes]-kernel-space-(noun))
...
**See also**: [knowledge base](#image:images/yes.png[yes]-knowledge-base-(noun))
...
**See also**: [OpenShift](#image:images/caution.png[with-caution]-openshift-(noun)), [OKD](#image:images/yes.png[yes]-okd-(noun))
...
**See also**: [OpenShift master](#image:images/yes.png[yes]-openshift-master-(noun))
...
**See also**: [Kernel-based Virtual Machine](#image:images/yes.png[yes]-kernel-based-virtual-machine-(noun))
...
**See also**: [LDAPS](#image:images/yes.png[yes]-ldaps-(noun)), [STARTTLS](#image:images/yes.png[yes]-starttls-(noun))
...
**See also**: [Ceph Block Device](#image:images/yes.png[yes]-ceph-block-device-(noun)), [RADOS Block Device](#image:images/caution.png[with-caution]-rados-block-device-(noun)), [RBD](#image:images/yes.png[yes]-rbd-(noun))
...
**See also**: [message routing](#image:images/yes.png[yes]-message-routing-(noun))
...
**See also**: [physical topology](#image:images/yes.png[yes]-physical-topology-(noun)), [signal-topology](#image:images/yes.png[yes]-signal-topology-(noun))
...
**See also**: [domain mode](#image:images/no.png[no]-domain-mode-(noun))
...
**See also**: [HTTP interface](#image:images/no.png[no]-http-interface-(noun))
...
**See also**: [man page](#image:images/yes.png[yes]-man-page-(noun))
...
**See also**: [supplier](#image:images/yes.png[yes]-supplier-(noun))
...
**See also**: [Mb](#image:images/yes.png[yes]-mb-(noun))
...
**See also**: [Metadata Server](#image:images/yes.png[yes]-metadata-server-(noun)), [ceph-mds](#image:images/yes.png[yes]-ceph-mds-(noun))
...
**See also**: [Messaging - ActiveMQ](#image:images/yes.png[yes]-messaging---activemq-(noun)), [messaging subsystem](#image:images/yes.png[yes]-messaging-subsystem-(noun))
...
**See also**: [MDS](#image:images/yes.png[yes]-mds-(noun)), [ceph-mds](#image:images/yes.png[yes]-ceph-mds-(noun))
...
**See also**: [z-stream](#image:images/caution.png[with-caution]-z-stream-(noun))
...
**See also**: [MS-DOS](#image:images/yes.png[yes]-ms-dos-(noun))
...
**See also**: [node](#image:images/yes.png[yes]-node-(noun))
...
**See also**: [Mozilla Thunderbird](#image:images/yes.png[yes]-mozilla-thunderbird-(noun))
...
**See also**: [Mozilla Firefox](#image:images/yes.png[yes]-mozilla-firefox-(noun))
...
**See also**: [Microsoft](#image:images/yes.png[yes]-microsoft-(noun))
...
**See also**: [federated](#image:images/yes.png[yes]-federated-(adjective))
...
**See also**: [mutual exclusion](#image:images/yes.png[yes]-mutual-exclusion-(noun)), [Mutexes](#image:images/yes.png[yes]-mutexes-(noun))
...
**See also**: [mutual exclusion](#image:images/yes.png[yes]-mutual-exclusion-(noun)), [Mutex](#image:images/yes.png[yes]-mutex-(noun))
...
**See also**: [Mutex](#image:images/yes.png[yes]-mutex-(noun)), [Mutexes](#image:images/yes.png[yes]-mutexes-(noun))
...
**See also**: [SQL](#image:images/yes.png[yes]-sql-(noun))
...
**See also**: [project](#image:images/yes.png[yes]-project-(noun))
...
**See also**: [management CLI](#image:images/yes.png[yes]-management-cli-(noun))
...
**See also**: [want](#image:images/caution.png[with-caution]-want-(verb))
...
**See also**: [.Net Core](#image:images/no.png[no]-.net-core-(noun))
...
**See also**: [.NET](#image:images/yes.png[yes]-.net-(noun))
...
**See also**: [network interface controller](#image:images/yes.png[yes]-network-interface-controller-(nic))
...
**See also**: [vNIC](#image:images/yes.png[yes]-vnic-(noun)), [SmartNIC](#image:images/yes.png[yes]-smartnic)
...
**See also**: [Open RAN](#image:images/caution.png[with-caution]-open-ran-(noun)), [OpenRAN](#image:images/caution.png[with-caution]-openran-(noun))
...
**See also**: [objectClass](#image:images/yes.png[yes]-objectclass-(noun))
...
**See also**: [object class](#image:images/yes.png[yes]-object-class-(noun))
...
**See also**: [disconnected](#image:images/yes.png[yes]-disconnected-(adjective))
...
**See also**: [online backup](#image:images/yes.png[yes]-online-backup-(noun))
...
**See also**: [on-board](#image:images/caution.png[with-caution]-on-board-(adjective))
...
**See also**: [offline backup](#image:images/yes.png[yes]-offline-backup-(noun))
...
**See also**: [O-RAN](#image:images/caution.png[with-caution]-o-ran-(noun)), [OpenRAN](#image:images/caution.png[with-caution]-openran-(noun))
...
**See also**: [O-RAN](#image:images/caution.png[with-caution]-o-ran-(noun)), [Open RAN](#image:images/caution.png[with-caution]-open-ran-(noun))
...
**See also**: [endpoint](#image:images/caution.png[with-caution]-endpoint-(noun)), [API server](#image:images/yes.png[yes]-api-server-(noun)), [scheduler](#image:images/yes.png[yes]-scheduler-(noun))
...
**See also**: [control program](#image:images/yes.png[yes]-control-program-(noun))
...
**See also**: [ceph-osd](#image:images/yes.png[yes]-ceph-osd-(noun)), [OSD](#image:images/yes.png[yes]-osd-(noun)), [Object Storage Device](#image:images/yes.png[yes]-object-storage-device-(noun))
...
**See also**: [undercloud](#image:images/yes.png[yes]-undercloud-(noun))
...
**See also**: [direct routed messaging](#image:images/yes.png[yes]-direct-routed-messaging-(noun))
...
**See also**: [privilege](#image:images/yes.png[yes]-privilege-(noun))
...
**See also**: [virtual disk](#image:images/yes.png[yes]-virtual-disk-(noun))
...
**See also**: [plugin](#image:images/yes.png[yes]-plugin-(noun))
...
**See also**: [plug-in](#image:images/caution.png[with-caution]-plug-in-(noun))
...
**See also**: [action](#image:images/yes.png[yes]-action-(noun)), [business rule](#image:images/yes.png[yes]-business-rule-(noun)), [business process](#image:images/yes.png[yes]-business-process-(noun))
...
**See also**: [permission](#image:images/yes.png[yes]-permission-(noun))
...
**See also**: [ROM](#image:images/yes.png[yes]-rom-(noun))
...
**See also**: [Puppet](#image:images/yes.png[yes]-puppet-(noun))
...
**See also**: [Ceph Object Gateway](#image:images/yes.png[yes]-ceph-object-gateway-(noun)), [RGW](#image:images/yes.png[yes]-rgw-(noun)), [ceph-radosgw](#image:images/yes.png[yes]-ceph-radosgw-(noun))
...
**See also**: [RAM disk](#image:images/yes.png[yes]-ram-disk-(noun))
...
**See also**: [RAM](#image:images/yes.png[yes]-ram-(noun))
...
**See also**: [cooked](#image:images/yes.png[yes]-cooked-(adjective))
...
**See also**: [read (verb)](#image:images/yes.png[yes]-read-(verb))
...
**See also**: [regular expression](#image:images/yes.png[yes]-regular-expression-(noun))
...
**See also**: [regex](#image:images/no.png[no]-regex-(noun))
...
**See also**: [remote access server](#image:images/yes.png[yes]-remote-access-server-(noun))
...
**See also**: [enter](#image:images/yes.png[yes]-enter-(noun))
...
**See also**: [rollout](#image:images/yes.png[yes]-rollout-(noun))
...
**See also**: [roll-out](#image:images/yes.png[yes]-roll-out-(verb))
...
**See also**: [PROM](#image:images/yes.png[yes]-prom-(noun))
...
**See also**: [roundtable](#image:images/yes.png[yes]-roundtable-(noun))
...
**See also**: [Ansible Rulebook](#image:images/yes.png[yes]-ansible-rulebook-(noun))
...
**See also**: [KIE API](#image:images/yes.png[yes]-kie-api-(noun))
...
**See also**:  [IBM Z](#image:images/yes.png[yes]-ibm-z®-(noun))
...
**See also**: [IaaS](#image:images/yes.png[yes]-iaas-(noun)), [PaaS](#image:images/yes.png[yes]-paas-(noun))
...
**See also**: [scale up](#image:images/yes.png[yes]-scale-up-(verb))
...
**See also**: [producer](#image:images/yes.png[yes]-producer-(noun)), [target](#image:images/yes.png[yes]-target-(noun)), [receiver](#image:images/yes.png[yes]-receiver-(noun))
...
**See also**: [server farm](#image:images/yes.png[yes]-server-farm-(noun))
...
**See also**: [sticky session](#image:images/yes.png[yes]-sticky-session-(noun))
...
**See also**: [SHA-2](#image:images/yes.png[yes]-sha-2-(noun))
...
**See also**: [SHA-1](#image:images/yes.png[yes]-sha-1-(noun))
...
**See also**: [queue](#image:images/yes.png[yes]-queue-(noun))
...
**See also**: [interpreter directive](#image:images/yes.png[yes]-interpreter-directive-(noun)), [hashbang](#image:images/no.png[no]-hashbang-(noun))
...
**See also**: [shell prompt](#image:images/yes.png[yes]-shell-prompt-(noun))
...
**See also**: [shell](#image:images/yes.png[yes]-shell-(noun))
...
**See also**: [master-slave group](#image:images/yes.png[yes]-master-slave-group-(noun)), [master broker](#image:images/yes.png[yes]-master-broker-(noun))
...
**See also**: [snapshot set](#image:images/yes.png[yes]-snapshot-set-(noun))
...
**See also**: [snap](#image:images/yes.png[yes]-snap-(noun))
...
**See also**: [sosreport](#image:images/caution.png[with-caution]-sosreport-(noun))
...
**See also**: [sos report](#image:images/caution.png[with-caution]-sos-report-(noun))
...
**See also**: [target](#image:images/yes.png[yes]-target-(noun))
...
**See also**: [spacebar](#image:images/yes.png[yes]-spacebar-(noun))
...
**See also**: [MySQL](#image:images/yes.png[yes]-mysql-(noun))
...
**See also**: [SSL/TLS](#image:images/yes.png[yes]-ssl/tls-(noun)), [TLS](#image:images/yes.png[yes]-tls-(noun))
...
**See also**: [LDAP](#image:images/yes.png[yes]-ldap-(noun)), [SSSD](#image:images/yes.png[yes]-sssd-(noun))
...
**See also**: [standalone mode](#image:images/no.png[no]-standalone-mode-(noun))
...
**See also**: [LDAP](#image:images/yes.png[yes]-ldap-(noun)), [LDAPS](#image:images/yes.png[yes]-ldaps-(noun))
...
**See also**: [OSTree](#image:images/yes.png[yes]-ostree-(noun)), [commit](#image:images/yes.png[yes]-commit-(noun))
...
**See also**: [session persistence](#image:images/yes.png[yes]-session-persistence-(noun))
...
**See also**: [consumer](#image:images/yes.png[yes]-consumer-(noun))
...
**See also**: [Fuse Online](#image:images/yes.png[yes]-fuse-online-(noun))
...
**See also**: [instrumentation module](#image:images/yes.png[yes]-instrumentation-module-(noun))
...
**See also**: [TTL](#image:images/yes.png[yes]-ttl-(noun)), [time-to-live](#image:images/yes.png[yes]-time-to-live-(adjective))
...
**See also**: [TTL](#image:images/yes.png[yes]-ttl-(noun)), [time to live](#image:images/yes.png[yes]-time-to-live-(noun))
...
**See also**: [SSL](#image:images/no.png[no]-ssl-(noun)), [SSL/TLS](#image:images/yes.png[yes]-ssl/tls-(noun)), [symmetric encryption](#image:images/yes.png[yes]-symmetric-encryption-(noun)), [TLS handshake](#image:images/yes.png[yes]-tls-handshake-(noun)), [trusted certificate authority](#image:images/yes.png[yes]-trusted-certificate-authority-(noun))
...
**See also**: [scriptlet directive](#image:images/yes.png[yes]-scriptlet-directive-(noun))
...
**See also**: [TLS](#image:images/yes.png[yes]-tls-(noun))
...
**See also**: [time-to-live](#image:images/yes.png[yes]-time-to-live-(adjective)), [time to live](#image:images/yes.png[yes]-time-to-live-(noun))
...
**See also**: [in-place upgrade](#image:images/yes.png[yes]-in-place-upgrade-(noun)), [clean install](#image:images/yes.png[yes]-clean-install-(noun))
...
**See also**: [downstream (noun)](#image:images/yes.png[yes]-downstream-(noun)), [downstream (adjective)](#image:images/yes.png[yes]-downstream-(adjective)), [upstream (noun)](#image:images/yes.png[yes]-upstream-(noun))
...
**See also**: [downstream (noun)](#image:images/yes.png[yes]-downstream-(noun)), [downstream (adjective)](#image:images/yes.png[yes]-downstream-(adjective)), [upstream (adjective)](#image:images/yes.png[yes]-upstream-(adjective))
...
**See also**: [endpoint](#image:images/caution.png[with-caution]-endpoint-(noun)), [URN](#image:images/yes.png[yes]-urn-(noun))
...
**See also**: [URI](#image:images/yes.png[yes]-uri-(noun))
...
**See also**: [user space](#image:images/yes.png[yes]-user-space-(noun))
...
**See also**: [OEM](#image:images/yes.png[yes]-oem-(noun))
...
**See also**: [action](#image:images/yes.png[yes]-action-(noun)), [project](#image:images/yes.png[yes]-project-(noun))
...
**See also**: [Vim](#image:images/yes.png[yes]-vim-(noun))
...
**See also**: [vi](#image:images/yes.png[yes]-vi-(noun))
...
**See also**: [virtualized](#image:images/yes.png[yes]-virtualized-(adjective))
...
**See also**: [physical disk](#image:images/yes.png[yes]-physical-disk-(noun))
...
**See also**: [virtual floppy drive](#image:images/yes.png[yes]-virtual-floppy-drive-(noun))
...
**See also**: [virtual floppy disk](#image:images/yes.png[yes]-virtual-floppy-disk-(noun))
...
**See also**: [virtual](#image:images/yes.png[yes]-virtual-(adjective))
...
**See also**: [guest operating system](#image:images/yes.png[yes]-guest-operating-system-(noun)), [virtual machine](#image:images/yes.png[yes]-virtual-machine-(noun))
...
**See also**: [Boolean dependencies](#image:images/yes.png[yes]-boolean-dependencies-(noun))
...
**See also**: [recommend](#image:images/no.png[no]-recommend-(verb))
...
**See also**: [whom](#image:images/yes.png[yes]-whom-(pronoun))
...
**See also**: [who](#image:images/yes.png[yes]-who-(pronoun))
...
**See also**: [XEmacs](#image:images/yes.png[yes]-xemacs-(noun))
...
**See also**: [64-bit x86](#image:images/yes.png[yes]-64-bit-x86-(noun))
...
**See also**: [Expansion Pack](#image:images/yes.png[yes]-expansion-pack-(noun))
...
**See also**: [zone](#image:images/yes.png[yes]-zone-(noun)), [realm](#image:images/yes.png[yes]-realm), [region](#image:images/yes.png[yes]-region-(noun))
...
**See also**: [aarch64](#image:images/yes.png[yes]-aarch64-(noun)), [arm64](#image:images/yes.png[yes]-arm64-(noun))
...
**See also**: [x86_64](#image:images/yes.png[yes]-x86_64-(noun))
